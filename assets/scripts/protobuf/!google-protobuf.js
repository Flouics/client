...
goog.crypt.byteArrayToString = function(a) {
    ...
    for (var b = "", c = 0; c < a.length; c += 8192) var d = goog.array.slice(a, c, c + 8192),
...
jspb.Message.initialize = function(a, b, c, d, e, f) {
    ...
    if (e)
        for (b = 0; b < e.length; b++) c = e[b], c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c), a.array[c] = a.array[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_ : [])) : a.extensionObject_[c] = a.extensionObject_[c] ||
                (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_ : []);
...
jspb.utils.hexStringToHash64 = function(a) {
    ...
    for (var b = "", c = 0; 8 > c; c++) var d = jspb.utils.DIGITS.indexOf(a[2 * c + 2]),
...
jspb.BinaryDecoder.prototype.readSplitVarint64_ = function() {
    ...
    b |= (a & 127) << 28;
    c = 0 | (a & 127) >> 4;
    if (128 > a) this.tempLow_ = b >>> 0, this.tempHigh_ = c >>> 0;
    else {
        for (d = 0; 5 > d; d++)
...
jspb.BinaryDecoder.prototype.readUnsignedVarint32 = function() {
    ...
    a = b[this.cursor_ + 4];
    c |= (a & 15) << 28;
    if (128 > a) return goog.asserts.assert(0 == (a & 240)), this.cursor_ += 5, goog.asserts.assert(this.cursor_ <= this.end_), c >>> 0;
    goog.asserts.assert(240 == (a & 240));
...
jspb.BinaryReader.prototype.skipGroup = function() {
    ...
    do {
        ...
        if (this.nextWireType_ == jspb.BinaryConstants.WireType.START_GROUP) a.push(this.nextField_);
...
jspb.arith.UInt64.prototype.toString = function() {
    for (var a = "", b = this; !b.zero();) var b = b.div(10),
        c = b[0],
        a = b[1].lo + a,
        b = c;
    "" == a && (a = "0");
...
jspb.BinaryWriter.prototype.writeRepeatedGroup = function(a, b, c) {
    if (null != b)
        for (var d = 0; d < b.length; d++) this.writeFieldHeader_(a, jspb.BinaryConstants.WireType.START_GROUP), c(b[d], this), this.writeFieldHeader_(a, jspb.BinaryConstants.WireType.END_GROUP)
};
